...
def greet():
    ...
    conn.commit()
    conn.close()
    SR.speak("\nMyself Didi. How may I help you?")
    ...
    try:
        while(True):
            ...
            #asking for name
                ...
                SR.speak("My name is Didi and I'm here to serve you.")
            #How are you
            elif there_exists(['how are you'],query):
                conn = sqlite3.connect('Iwan.db')
                mycursor=conn.cursor()
...
if __name__=="__main__":
        ...
        Speak_label=tk.Label(root,text="Berikan Perintah :",fg="#FFD700",font='"Times New Roman" 12 ',borderwidth=0,bg='#2c4557')
        Speak_label.place(x=200,y=300)
        """Setting up objects"""
